...
final class CreateTodos extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('user_id', 'integer', ['limit' => MysqlAdapter::INT_BIG, 'null' => false, 'comment' => '用户id'])
            ...
            ->addColumn('start_at', 'integer', ['limit' => MysqlAdapter::INT_BIG, 'null' => true, 'comment' => '起始时间'])
            ->addColumn('end_at', 'integer', ['limit' => MysqlAdapter::INT_BIG, 'null' => true, 'comment' => '结束时间'])
            ->addColumn('completed_at', 'integer', ['limit' => MysqlAdapter::INT_BIG, 'null' => true, 'comment' => '非重复事项专用，完成时间'])
            ->addColumn('repeat_type', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'null' => false, 'comment' => '重复类型'])
            ->addColumn('repeat_count', 'integer', ['limit' => MysqlAdapter::INT_MEDIUM, 'null' => true, 'comment' => '自定义重复间隔数'])
